...
#######################################
getApplicationName() {
    echo $(node -e "require('$SCRIPTS_LOCATION/util-functions.js').getApplicationName($1)")
}
...
getApplicationPackageName() {
    echo $(node -e "require('$SCRIPTS_LOCATION/util-functions.js').getApplicationPackageName($1)")
}
...
getApplicationApkName() {
    echo $(node -e "require('$SCRIPTS_LOCATION/util-functions.js').getPackageApkVersion('$1')")
}
...
#######################################
getApplicationType() {
    echo $(node -e "require('$SCRIPTS_LOCATION/util-functions.js').getApplicationType($1)")
}